    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .sessionManagement((sessionManagement) -> sessionManagement
                        ...
                        /*
                         * Maximum number of sessions (1 tài khoản đăng nhập được tối đa trên bao nhiêu
                         * thiết bị
                         * => TH1: .maxSessionsPreventsLogin(true) => Nếu 1 tài khoản đã đc đăng nhập
                         * trên thiết bị này rồi thì thiết bị khác không đăng nhập được => hết session
                         * mới login được)
                         * 
                         * => TH2: .maxSessionsPreventsLogin(false) => Nếu 1 tài khoản đã đc đăng nhập
                         * và sau đó đăng nhập trên thiết bị khác thì thiết bị cũ sẽ bị logout
                         */
                        .maximumSessions(1)
